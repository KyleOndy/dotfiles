...
switch-home: auto-env.nix check ## Switch to latest home config
...
auto-env.nix:
	...
	echo "{ pkgs, ... }:" > ./home/auto-env.nix
	echo "{ home.sessionVariables = {" >> ./home/auto-env.nix
	echo "NIXOS_CONFIG = \"$(CURDIR)/hosts/$(HOSTNAME)/configuration.nix\";" >> ./home/auto-env.nix
