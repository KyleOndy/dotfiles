...
Use the AskUserQuestion tool to get user guidance:

**Question:** "I found some decisions that need your input before proceeding. How would you like to handle them?"
**Header:** "Decisions"
**Options:**

- Label: "Review each decision now"
  Description: "I'll present each decision point for your input"
- Label: "Make reasonable defaults"
  Description: "I'll use my best judgment and note assumptions in the plan"
- Label: "Stop and discuss"
  Description: "Let's discuss the unknowns before continuing"
...
Use the AskUserQuestion tool to confirm the plan:

**Question:** "I've completed the implementation plan. How would you like to proceed?"
**Header:** "Plan Review"
**Options:**

- Label: "Approve and implement"
  Description: "The plan looks good - start implementation"
- Label: "Request changes"
  Description: "I have feedback or changes to the plan"
- Label: "Ask questions first"
  Description: "I have questions before approving"

**Handle responses:**

- "Approve and implement" → Plan is approved, ready for implementation
- "Request changes" → Ask what changes they want, update plan file, re-present
- "Ask questions first" → Wait for their questions, answer them, then re-ask
