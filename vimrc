...
map <S-Enter> o<Esc>            " Shift Enter will insert a newline below cursor

" Below builds CTags in the current directory.
...
filetype plugin on
set completeopt+=longest        " Continue typing while completion is open
