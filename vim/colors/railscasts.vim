...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>dotfiles/vim/colors/railscasts.vim at master · ryanb/dotfiles · GitHub</title>
...
<meta content="079dLEORX8bRvgYMHSWt++FhMIkR54mA0p7410A15RE=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/assets/github-85c9c8ab1f3c8451e39424e1d687e8397c3b8fbf.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/ryanb/dotfiles/blob/ce2f57c698e9d6dabdbb85fd72645d402cc0e646/vim/colors/railscasts.vim'>
  ...
  <body class="logged_out page-blob linux vis-public env-production ">
    ...
    <ul class="top-nav logged_out">
      ...
      <li class="login"><a href="https://github.com/login?return_to=%2Fryanb%2Fdotfiles%2Fblob%2Fmaster%2Fvim%2Fcolors%2Frailscasts.vim">Sign in</a></li>
    </ul>
      ...
      <div class="hentry">
        ...
        <div class="pagehead repohead instapaper_ignore readability-menu">
          ...
          <li>
            <span class="star-button"><a href="/login?return_to=%2Fryanb%2Fdotfiles" class="minibutton js-toggler-target entice tooltipped leftwards" title="You must be signed in to use this feature" rel="nofollow"><span class="mini-icon mini-icon-star"></span>Star</a><a class="social-count js-social-count" href="/ryanb/dotfiles/stargazers">1,382</a></span>
          </li>
          <li>
            <a href="/login?return_to=%2Fryanb%2Fdotfiles" class="minibutton js-toggler-target fork-button entice tooltipped leftwards"  title="You must be signed in to fork a repository" rel="nofollow"><span class="mini-icon mini-icon-fork"></span>Fork</a><a href="/ryanb/dotfiles/network" class="social-count">579</a>
          </li>
    </ul>
  ...
  <ul class="tabs">
    <li><a href="/ryanb/dotfiles" class="selected" highlight="repo_sourcerepo_downloadsrepo_commitsrepo_tagsrepo_branches">Code</a></li>
    ...
    <li><a href="/ryanb/dotfiles/graphs" highlight="repo_graphsrepo_contributors">Graphs</a></li>


  </ul>
  
  <div class="frame frame-center tree-finder" style="display:none"
      data-tree-list-url="/ryanb/dotfiles/tree-list/ce2f57c698e9d6dabdbb85fd72645d402cc0e646"
      data-blob-url-prefix="/ryanb/dotfiles/blob/master">

  <div class="breadcrumb">
    <span class="bold"><a href="/ryanb/dotfiles">dotfiles</a></span> /
    <input class="tree-finder-input js-navigation-enable" type="text" name="query" autocomplete="off" spellcheck="false">
  </div>

    <div class="octotip">
      <p>
        <a href="/ryanb/dotfiles/dismiss-tree-finder-help" class="dismiss js-dismiss-tree-list-help" title="Hide this notice forever" rel="nofollow">Dismiss</a>
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
      ...
      <li><a href="/ryanb/dotfiles/downloads" class="tabnav-tab" highlight="repo_downloads">Downloads <span class="counter blank">0</span></a></li>
    </ul>
          ...
          <div class="js-filter-tab js-filter-branches" data-filterable-for="context-commitish-filter-field" data-filterable-type=substring>
            <div class="no-results js-not-filterable">Nothing to show</div>
              <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target ">
                ...
                <h4>
                    <a href="/ryanb/dotfiles/blob/custom-bash-zsh/vim/colors/railscasts.vim" class="js-navigation-open" data-name="custom-bash-zsh" rel="nofollow">custom-bash-zsh</a>
                </h4>
              </div>
              <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target selected">
                <span class="mini-icon mini-icon-confirm"></span>
                <h4>
                    <a href="/ryanb/dotfiles/blob/master/vim/colors/railscasts.vim" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                </h4>
              </div>
          </div>
...
<div id="slider">
    ...
    <div class="breadcrumb" data-path="vim/colors/railscasts.vim/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/ryanb/dotfiles" itemscope="url"><span itemprop="title">dotfiles</span></a></b> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/ryanb/dotfiles/tree/master/vim" itemscope="url"><span itemprop="title">vim</span></a></span> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/ryanb/dotfiles/tree/master/vim/colors" itemscope="url"><span itemprop="title">colors</span></a></span> / <strong class="final-path">railscasts.vim</strong> <span class="js-clippy mini-icon mini-icon-clippy " data-clipboard-text="vim/colors/railscasts.vim" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>

      
  <div class="commit file-history-tease js-blob-contributors-content" data-path="vim/colors/railscasts.vim/">
    ...
    <span class="author"><a href="/ryanb">ryanb</a></span>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="vim/colors/railscasts.vim/" data-permalink-url="/ryanb/dotfiles/blob/ce2f57c698e9d6dabdbb85fd72645d402cc0e646/vim/colors/railscasts.vim" data-title="dotfiles/vim/colors/railscasts.vim at master · ryanb/dotfiles · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter" href="/ryanb/dotfiles/edit/master/vim/colors/railscasts.vim" data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
                  </li>
                <li>
                  <a href="/ryanb/dotfiles/raw/master/vim/colors/railscasts.vim" class="minibutton grouped-button bigger lighter" id="raw-url">Raw</a>
                </li>
                  <li>
                    <a href="/ryanb/dotfiles/blame/master/vim/colors/railscasts.vim" class="minibutton grouped-button bigger lighter">Blame</a>
                  </li>
                <li>
                  <a href="/ryanb/dotfiles/commits/master/vim/colors/railscasts.vim" class="minibutton grouped-button bigger lighter" rel="nofollow">History</a>
                </li>
              </ul>
            </div>
...
<div class="frame frame-loading large-loading-area" style="display:none;" data-tree-list-url="/ryanb/dotfiles/tree-list/ce2f57c698e9d6dabdbb85fd72645d402cc0e646">
...
<div class="lower_footer">
  <div class="container clearfix">
    <div id="legal">
      ...
      <p>&copy; 2012 <span title="0.05157s from fe16.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.05294' data-host='fe16'></span>
