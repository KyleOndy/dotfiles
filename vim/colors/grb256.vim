...
<meta content="079dLEORX8bRvgYMHSWt++FhMIkR54mA0p7410A15RE=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/assets/github-85c9c8ab1f3c8451e39424e1d687e8397c3b8fbf.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/garybernhardt/dotfiles/blob/32a7384aa996f6875a285e7d0f4fd4b0f4af9263/.vim/colors/grb256.vim'>
  ...
  <body class="logged_out page-blob linux vis-public env-production ">
    ...
    <ul class="top-nav logged_out">
      ...
      <li class="login"><a href="https://github.com/login?return_to=%2Fgarybernhardt%2Fdotfiles%2Fblob%2Fmaster%2F.vim%2Fcolors%2Fgrb256.vim">Sign in</a></li>
    </ul>
      ...
      <div class="hentry">
        ...
        <div class="pagehead repohead instapaper_ignore readability-menu">
          ...
          <li>
            <span class="star-button"><a href="/login?return_to=%2Fgarybernhardt%2Fdotfiles" class="minibutton js-toggler-target entice tooltipped leftwards" title="You must be signed in to use this feature" rel="nofollow"><span class="mini-icon mini-icon-star"></span>Star</a><a class="social-count js-social-count" href="/garybernhardt/dotfiles/stargazers">420</a></span>
          </li>
          <li>
            <a href="/login?return_to=%2Fgarybernhardt%2Fdotfiles" class="minibutton js-toggler-target fork-button entice tooltipped leftwards"  title="You must be signed in to fork a repository" rel="nofollow"><span class="mini-icon mini-icon-fork"></span>Fork</a><a href="/garybernhardt/dotfiles/network" class="social-count">71</a>
          </li>
    </ul>
  ...
  <ul class="tabs">
    ...
    <li><a href="/garybernhardt/dotfiles/network" highlight="repo_network">Network</a></li>
    <li><a href="/garybernhardt/dotfiles/pulls" highlight="repo_pulls">Pull Requests <span class='counter'>2</span></a></li>

      <li><a href="/garybernhardt/dotfiles/issues" highlight="repo_issues">Issues <span class='counter'>2</span></a></li>
  ...
  <div class="frame frame-center tree-finder" style="display:none"
      data-tree-list-url="/garybernhardt/dotfiles/tree-list/32a7384aa996f6875a285e7d0f4fd4b0f4af9263"
      data-blob-url-prefix="/garybernhardt/dotfiles/blob/master">
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
      <li><a href="/garybernhardt/dotfiles/tags" class="tabnav-tab" highlight="repo_tags">Tags <span class="counter blank">0</span></a></li>
      <li><a href="/garybernhardt/dotfiles/downloads" class="tabnav-tab" highlight="repo_downloads">Downloads <span class="counter blank">0</span></a></li>
    </ul>
          ...
          <div class="js-filter-tab js-filter-branches" data-filterable-for="context-commitish-filter-field" data-filterable-type=substring>
            <div class="no-results js-not-filterable">Nothing to show</div>
              <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target selected">
                ...
                <h4>
                    <a href="/garybernhardt/dotfiles/blob/master/.vim/colors/grb256.vim" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                </h4>
              </div>
          </div>
  ...
  <ul class="tabnav-tabs">
    <li><a href="/garybernhardt/dotfiles" class="selected tabnav-tab" highlight="repo_source">Files</a></li>
    <li><a href="/garybernhardt/dotfiles/commits/master" class="tabnav-tab" highlight="repo_commits">Commits</a></li>
    <li><a href="/garybernhardt/dotfiles/branches" class="tabnav-tab" highlight="repo_branches" rel="nofollow">Branches <span class="counter ">1</span></a></li>
  </ul>
...
<div id="slider">
    ...
    <div class="breadcrumb" data-path=".vim/colors/grb256.vim/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/garybernhardt/dotfiles" itemscope="url"><span itemprop="title">dotfiles</span></a></b> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/garybernhardt/dotfiles/tree/master/.vim" itemscope="url"><span itemprop="title">.vim</span></a></span> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/garybernhardt/dotfiles/tree/master/.vim/colors" itemscope="url"><span itemprop="title">colors</span></a></span> / <strong class="final-path">grb256.vim</strong> <span class="js-clippy mini-icon mini-icon-clippy " data-clipboard-text=".vim/colors/grb256.vim" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>

      
  <div class="commit file-history-tease js-blob-contributors-content" data-path=".vim/colors/grb256.vim/">
    ...
    <div class="frames">
      <div class="frame frame-center" data-path=".vim/colors/grb256.vim/" data-permalink-url="/garybernhardt/dotfiles/blob/32a7384aa996f6875a285e7d0f4fd4b0f4af9263/.vim/colors/grb256.vim" data-title="dotfiles/.vim/colors/grb256.vim at master · garybernhardt/dotfiles · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter" href="/garybernhardt/dotfiles/edit/master/.vim/colors/grb256.vim" data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
                  </li>
                <li>
                  <a href="/garybernhardt/dotfiles/raw/master/.vim/colors/grb256.vim" class="minibutton grouped-button bigger lighter" id="raw-url">Raw</a>
                </li>
                  <li>
                    <a href="/garybernhardt/dotfiles/blame/master/.vim/colors/grb256.vim" class="minibutton grouped-button bigger lighter">Blame</a>
                  </li>
                <li>
                  <a href="/garybernhardt/dotfiles/commits/master/.vim/colors/grb256.vim" class="minibutton grouped-button bigger lighter" rel="nofollow">History</a>
                </li>
              </ul>
            </div>
...
<div class="frame frame-loading large-loading-area" style="display:none;" data-tree-list-url="/garybernhardt/dotfiles/tree-list/32a7384aa996f6875a285e7d0f4fd4b0f4af9263">
...
<div class="lower_footer">
  <div class="container clearfix">
    <div id="legal">
      ...
      <p>&copy; 2012 <span title="0.04494s from fe16.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.04648' data-host='fe16'></span>
