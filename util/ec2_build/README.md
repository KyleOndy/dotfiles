...
```bash
# Build cogsworth (Raspberry Pi 5, aarch64)
make build-cogsworth-sdimage    # SD image for reflashing
...
# Examples:
./build-remote c7g.16xlarge aarch64-linux .#nixosConfigurations.cogsworth.config.system.build.toplevel
./build-remote c7g.8xlarge aarch64-linux .#myArmPackage
