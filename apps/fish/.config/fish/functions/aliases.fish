...
function treea1; treea -L 1 $argv; end
function treea2; treea -L 2 $argv; end
function treea3; treea -L 3 $argv; end
function treea4; treea -L 4 $argv; end
function treea5; treea -L 5 $argv; end
function treea6; treea -L 6 $argv; end
